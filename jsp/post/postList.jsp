...
// viewPage ->1,2,3,4,~10
// startno = 1, last = 10;
int vPage = Integer.parseInt(viewPage); // viewpage는 연산이 안되기 때문에 vpage 생성

// 예시) vpage -> 1,~,10 인 경우 :: startno = 1, lastno = 10;
//          vpage -> 11 ~ 20
// startno = ((20-1)/10)*10 + 1 ; // 11
...
s_pageno =  ((vPage-1)/10)*10+1; // 1, 반복문 시작 값
e_pageno =    s_pageno+(10-1); //10, 반복문 종료 값
